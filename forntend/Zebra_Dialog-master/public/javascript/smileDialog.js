...
;(function($) {
    ...
    $.smileDialog = function() {
        ...
        var defaults = {
            ...
            buttons:                    true,           //  Use this for localization and for adding custom buttons.
                                                        ...
                                                        //  type and ['确定'] for the other dialog box types.
                                                        //
            ...
            custom_class:                false,         //  An extra class to add to the dialog box's container. Useful
                                                        ...
                                                        //  .mycustom .smileDialog_Title { background: red }
            ...
            type:                       'information',  //  Dialog box type.
                                                        ...
                                                        //  with the caption "确定"; type "question" has two buttons, with
                                                        //  the captions "确定" and "Cancel" respectively.
                                                        //
        ...
        plugin.init = function() {
            ...
            var $title,idNum=idNum || Math.floor(Math.random() * 9999999);
            ...
            if (plugin.settings.modal) {
                ...
                // create the overlay
                plugin.overlay = $('<div>', {
                    'id':'smileDialogOverlay_'+idNum,
                    'class':    'smileDialogOverlay'
            ...
            plugin.dialog = $('<div>', {
                'id':'smileDialog_'+idNum,
                'class':        'smileDialog' + (plugin.settings.custom_class ? ' ' + plugin.settings.custom_class : '')
            ...
            if (!plugin.settings.buttons && plugin.settings.auto_close)
                ...
                plugin.dialog.attr('id', 'smileDialog_' + idNum);
            ...
            var body_container = $('<div>', {
                ...
                'class':    'smileDialog_BodyOuter' + (!plugin.settings.title ? ' smileDialog_NoTitle' : '') + (!buttons ? ' smileDialog_NoButtons' : '')
            ...
            plugin.message = $('<div>', {
                ...
                'class':    'smileDialog_Body' + (get_type() !== false ? ' smileDialog_Icon smileDialog_' + get_type() : '')
                    ...
                    switch (type) {
                        ...
                        case 'ajax':
                            ...
                            var
                                ...
                                preloader = $('<div>').attr('class', 'smileDialog_Preloader').appendTo(canvas);
            ...
            if (buttons) {
                ...
                $.each(buttons, function(index, value) {
                    ...
                    var button = $('<a>', {
                        ...
                        'class':    'smileDialog_Button_' + index
                ...
                button_bar.wrap($('<div>').addClass('smileDialog_ButtonsOuter' + (plugin.settings.center_buttons ? ' smileDialog_Buttons_Centered' : '')));
            ...
            if (plugin.settings.show_close_button) {
                ...
                var $close = $('<a href="javascript:void(0)" class="smileDialog_Close">&times;</a>').bind('click', function(e){
            ...
            $(window).bind('resize.smileDialog', function() {
            ...
            if (plugin.settings.keyboard)
                ...
                // if a key is pressed
                $(document).bind('keyup.smileDialog', function(e) {
            ...
            if (plugin.isIE6)
                ...
                $(window).bind('scroll.smileDialog', function() {
        ...
        plugin.close = function(caption) {
            ...
            $(document).unbind('.smileDialog');
            $(window).unbind('.smileDialog');
        ...
        var draw = function() {
            ...
            plugin.dialog.find('a[class^=smileDialog_Button]:first').focus();
    ...
    $.smileConfirmDialog = function(text) {
        var deferred = jQuery.Deferred();
        //var idNum = Math.floor(Math.random() * 9999999);
        
        var text = '<div class="modal" id="nocomplete-modal' + idNum + '">\
                        <h1>股票卖出</h1>\
